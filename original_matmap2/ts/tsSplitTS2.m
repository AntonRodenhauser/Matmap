function varargout = tsSplitTS2(varargin)

% FUNCTION [newTSindices1,newTSindices2,...] = tsSplitTS(indices,channels,[newfilename],[nextchannels,nextnewfilename,...])
