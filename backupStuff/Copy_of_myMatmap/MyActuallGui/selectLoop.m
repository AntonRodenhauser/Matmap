...
%%%% set the default loop Order
if ~isfield(myScriptData, 'LOOP_ORDER')
    myScriptData.LOOP_ORDER=[2 3 4 5 1]  %DODO this is wrong, needr right length etc..
end
...
while 1
    ...
    nextIndex=loop_order(currentIndex);   
    if ~isempty(find(currentIndex==loopString))
        break   
    end
end
